...
def output_weight_v3(step, PENETRATION_RATE):
    ...
    model = cnnModel.CNNv3()
    model = model.double()
    model.load_state_dict(torch.load('data/model/model3_params2_ONLYTIME.pkl'))
    model.eval()
...
def run_collectdata(penetration_rate):
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if step % 15 == 0:
            ...
            output_state_v2(step, penetration_rate)
